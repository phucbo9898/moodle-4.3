...
class primary extends view {
    ...
    public function initialise(): void {
        ...
        if (isloggedin() && !isguestuser()) {
            ...
            // Add the example management link.
            $this->add('Example management', new \moodle_url('/local/message/manage.php'),
                self::TYPE_SETTING, null, 'example', new \pix_icon('i/local/messsage', ''));
